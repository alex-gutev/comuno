...
package Paths is
   ...
   --  (False).
   --
   function Make_Path (Components : Component_Array; Directory : Boolean := False) return Path;
   function Make_Path (Components : Component_Vector; Directory : Boolean := False) return Path;
   ...
   procedure Ensure_Directory (P : in out Path; Directory : in Boolean := True);
